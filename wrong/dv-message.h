...
class DVMessage : public Header
{
  ...
  public:
    ...
    void SetHelloReq(Ipv4Address destinationAddress, std::string helloMessage);
    HelloReq GetHelloReq();

    void SetHelloRsp(Ipv4Address destinationAddress, std::string helloMessage);
